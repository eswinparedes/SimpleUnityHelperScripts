...
{
    [CreateAssetMenu(menuName = "SUHS/Audio/Audio One Shot Request")]
    public class AudioOneShotRequestSO : AAudioOneShotRequestSO
    {
        ...
        [SerializeField] AudioClip m_clip = default;
